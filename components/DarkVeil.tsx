...
export default function DarkVeil({
  ...
  useEffect(() => {
    ...
    const resize = () => {
      ...
      // ogl's setSize pins the canvas's CSS box to the (scaled-down) render
      // size via inline styles, which leaves the container partly uncovered.
      // Force it back to fill the container; the browser then just upscales
      // the lower-resolution drawing buffer, which is what resolutionScale
      // is meant to achieve.
